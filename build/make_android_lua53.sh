...
cp build_v7a/libulua.so plugin_lua53/Plugins/Android/libs/armeabi-v7a/libulua.so
...
cp build_x86/libulua.so plugin_lua53/Plugins/Android/libs/x86/libulua.so
