...
echo "cmake build_lj_v7a finish"
cd "$DIR"
cmake --build build_lj_v7a --config Release
mkdir -p plugin_luajit/Plugins/Android/libs/armeabi-v7a/
cp build_lj_v7a/libulua.so plugin_luajit/Plugins/Android/libs/armeabi-v7a/libulua.so
...
cp build_lj_x86/libulua.so plugin_luajit/Plugins/Android/libs/x86/libulua.so
