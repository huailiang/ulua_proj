...
function prt_behit( ... )
	...
	print("*** lua seq ******")
	print(g_BeHit[1]['ChangeFlyTime'][0], g_BeHit[1]["ChangeFlyTime"][1], util.to_seq(g_BeHit,2,"ChangeFlyTime",1))
...
fruits = {"apple", "org", nil, "banana"}

print(#fruits, util.table_len(fruits))