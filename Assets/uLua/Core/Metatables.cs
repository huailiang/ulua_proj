namespace LuaInterface
{
    ...
    return index";
        ...
        public static int toString(IntPtr luaState)
        {
            ...
            else LuaAPI.lua_pushnil(luaState);
            return 1;
        }
        ...
        public static int getBaseMethod(IntPtr luaState)
        {
            ...
            if (LuaAPI.lua_type(luaState, -1) == LuaTypes.LUA_TNIL)
            {
                LuaAPI.lua_settop(luaState, -2);
        ...
        public static int callConstructor(IntPtr luaState)
        {
            ...
            if (obj == null || !(obj is IReflect))
            {
                LuaAPI.luaL_error(luaState, "trying to call constructor on an invalid type reference");
                LuaAPI.lua_pushnil(luaState);
                return 1;
            }
            else klass = (IReflect)obj;
            ...
            LuaAPI.luaL_error(luaState, String.Format("{0} does not contain constructor({1}) argument match",
        ...
        private bool _IsParamsArray(IntPtr luaState, int currentLuaParam, ParameterInfo currentNetParam, out ExtractValue extractValue)
        {
            ...
            if (currentNetParam.GetCustomAttributes(typeof(ParamArrayAttribute), false).Length > 0)
            {
                ...
                try
                {
                    luaType = LuaAPI.lua_type(luaState, currentLuaParam);
                }
                catch (Exception ex)
                {
